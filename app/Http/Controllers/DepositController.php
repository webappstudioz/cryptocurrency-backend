...
class DepositController extends Controller
{
    ...
    */
    public function deposit(Request $request){
        try{
            $validationRules = [
                ...
                'send_to'        => 'required_if:payment_type,deposit'
            ];
            ...
            Deposit::create([
                'send_from'     => authId(),
                'send_to'       => $request->send_to ? decryptData($request->send_to) : 1,
    ...
    Method Name:    list
    Developer:      Skillskore
    Purpose:        To get the list of deposit
    Params:
    */
    public function list(Request $request){
        try{
            ...
            return $this->apiResponse('success', '200', 'Deposit detail '. config('constants.SUCCESS.FETCH_DONE'), $data); 
    ...
    */
    public function changeStatus(Request $request){
        try{
            ...
            Deposit::where('id',decryptData($request->deposit_id))->update(['status'  => $request->status]);
    ...
    Method Name:    detail
    Developer:      Skillskore
    Purpose:        To update the deposit detail
    Params:
    */
    public function detail( $id){
        try{
            $depositData = [];
            $deposit = Deposit::find(decryptData($id));
            ...
            return $this->apiResponse('success', '200', 'Deposit detail '. config('constants.SUCCESS.FETCH_DONE'), $depositData); 
